-- CodeCrafter Database Setup Script - FIXED VERSION
...
-- Create badge_library table (create this first)
...
-- Create badges table (create this after badge_library)
CREATE TABLE badges (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
...
-- Insert initial earned badges (starter badges) - FIXED VERSION
