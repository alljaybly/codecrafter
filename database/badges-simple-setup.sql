-- Simple Badges Table Setup (Fixed Syntax)
...
CREATE POLICY IF NOT EXISTS "Allow all operations on badges" ON badges FOR ALL USING (true);
...
-- Verify the setup
SELECT 'Badges table created successfully!' as status;
